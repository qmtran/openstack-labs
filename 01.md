...
6. Look over the chart and notice that the release date of Kilo is the same date that was being displayed each time you issued the `[$SERVICE]-manage --version command`.
